...
// Effects
constexpr uint8_t NUM_EFFECTS = 7;
constexpr uint8_t EFFECT_RAINBOW   = 0;
constexpr uint8_t EFFECT_FIRE      = 1;
constexpr uint8_t EFFECT_PULSE     = 2;
constexpr uint8_t EFFECT_SPARKLE   = 3;
constexpr uint8_t EFFECT_SOLID     = 4;
constexpr uint8_t EFFECT_BASS_PULSE = 5;
constexpr uint8_t EFFECT_SPECTRUM  = 6;
